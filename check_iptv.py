...
def main():
    ...
    if total_ok == 0:
        ...
        print("   请检查 live_fail.txt 确认是否判定过严。")
        sys.exit(0)
    ...
    print(f"   live_report.csv ← 检测报告（含类型列）")
